...
<div class="content container-fluid">
 ...
 <div class="col-12 col-sm-4">
            <div class="form-group">
                <label class="input-label">{{ \App\CPU\translate('الخزن') }} <span class="input-label-secondary text-danger">*</span></label>
                <select type="text" name="storage_id" class="form-control" required>
                    ...
                    @endforeach
                            ...
                            <div class="row pl-2" >
                                <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                        <label class="input-label" >{{\App\CPU\translate('قيمة الحساب')}}</label>
