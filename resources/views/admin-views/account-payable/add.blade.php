            ...
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i
                            class="tio-add-circle-outlined"></i> {{\App\CPU\translate('اضافة راس مال')}}
                    </h1>
                </div>
            </div>
        </div>
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i
                            class="tio-files"></i> {{\App\CPU\translate('قائمة رؤوس الاموال')}}</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
                        ...
                        <div class="row justify-content-between align-items-center flex-grow-1">
                            ...
                            <div class="col-7">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <button href="" class="btn btn-success mt-4"> {{\App\CPU\translate('بحث')}}</button>
                                    </div>
                                </div>
                                </form>
                            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">{{\App\CPU\translate('تحويلات روؤس اموال')}}</h5>
