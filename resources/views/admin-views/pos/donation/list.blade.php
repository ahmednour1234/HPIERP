    ...
    <div class="content container-fluid">
        ...
        <div class="">
            <div class="row align-items-center mb-3">
                <div class="col-sm">
                    <h1 class="page-header-title text-capitalize">{{\App\CPU\translate('pos')}} {{\App\CPU\translate('تبرعات')}}
                        <span
...
<div class="card shadow-sm border-0 mb-4">
    ...
    <div class="row mb-3">
        <div class="col-md-3">
            <strong>{{ \App\CPU\translate('إجمالي التبرعات') }}:</strong> {{ number_format($orderAmountSum, 2) }}
        </div>
        <div class="col-md-3">
            <strong>{{ \App\CPU\translate('إجمالي المبالغ المحصلة') }}:</strong> 0.0
        </div>
        <div class="col-md-3">  
            <strong>{{ \App\CPU\translate('إجمالي عدد المنتجات التبرعات') }}:</strong> {{ $productCount }}
        </div>
        <div class="col-md-3">
            <strong>{{ \App\CPU\translate('إجمالي كميات المنتجات التبرعات') }}:</strong> {{ $quantitySum }}
        </div>
    </div>    
            <!-- End Header -->
            ...
            <div class="table-responsive ">
                ...
                >
                    ...
                    <tr>
                        ...
                        <th class="table-column-pl-0">{{\App\CPU\translate('تبرعات')}}</th>
    ...
    function printTable() {
        ...
        printWindow.document.write(`
            ...
            <head>
                ...
                <title>{{ \App\CPU\translate('تقرير التبرعات') }}</title>
                <style>
...
#links{
    display: block;
            ...
            <div class="header-section">
                ...
                <h2>{{ \App\CPU\translate('تقرير   التبرعات') }}</h2>
