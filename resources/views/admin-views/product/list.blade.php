        ...
        <div class="">
            <div class="d-flex align-items-center g-2px align-items-center mb-3">
                <h1 class="page-header-title d-flex align-items-center g-2px text-capitalize">
                    <i class="tio-files"></i> <span>{{ \App\CPU\translate('قائمة المنتجات') }}
                    ...
                    <div class="table-responsive datatable-custom" id="product-table">
                        <table class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table">
                            ...
                            <tr>
                                ...
                                <th>{{ \App\CPU\translate('سعر بيع') }}</th>
                                <th>{{ \App\CPU\translate('سعر شراء') }}</th>
...
<td>
    <div class="d-flex gap-2">
        <div class="d-inline">
            <a class="btn btn-white mr-1" href="{{ route('admin.product.edit', [$product['id']]) }}"> 
                <span class="tio-edit"></span>
            </a>
        </div>
        <div class="d-inline">
            <a class="btn btn-white mr-1" href="javascript:"   onclick="form_alert('product-{{ $product['id'] }}', 'Want to delete this Product?')">
        ...
        <div class="d-inline">
            <a class="btn btn-white mr-1" data-toggle="tooltip" data-placement="top" title="{{ \App\CPU\translate('انشاء كود') }}" href="{{ route('admin.product.barcode-generate', [$product['id']]) }}" target="_blank">
                <span class="tio-barcode"></span>
            </a>
        </div>
        <!-- New Button for Listing Products by Order Type -->
     <div class="d-inline">
    <a class="btn btn-white mr-1" href="{{ route('admin.product.listProductsByOrderType', ['product_id' => $product['id']]) }}" data-toggle="tooltip" data-placement="top" title="{{ __('متابعة حركة صنف') }}">
