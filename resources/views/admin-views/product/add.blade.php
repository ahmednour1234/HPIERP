            ...
            <div class="row align-items-center mb-3">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title d-flex align-items-center g-2px text-capitalize">
                        ...
                        <span>{{\App\CPU\translate('اضافة منتج')}}</span>
                    </h1>
                </div>
            </div>
        </div>
                        ...
                        <form action="{{route('admin.product.store')}}" method="post" id="product_form"
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                        <label class="input-label"
                                               for="exampleFormControlInput1">{{\App\CPU\translate('الاسم بالعربي')}}
                                            <span class="input-label-secondary">*</span>
                                        </label>
                                        <input type="text" name="name" class="form-control" value="{{ old('name') }}"
                                               placeholder="{{\App\CPU\translate('product_name_in_arabic')}}" required>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                        <label class="input-label"
                                               for="exampleFormControlInput1">{{\App\CPU\translate('الاسم بالانجليزي')}}
                                            <span class="input-label-secondary">*</span>
                                        </label>
                            ...
                            <div class="row pl-2">
                                <div class="col-12">
                                    <div class="form-group">
                                        <label class="input-label"
                                               for="exampleFormControlInput1">{{\App\CPU\translate('انشاء كود اتوماتيك')}}
                                            <span class="input-label-secondary">*</span>
                                            <a class="style-one-pro"
                                               onclick="document.getElementById('generate_number').value = getRndInteger()">{{\App\CPU\translate('انشاء كود')}}</a></label>
                            ...
                            <div class="row pl-2">
                                <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                        <label class="input-label"
                                               for="exampleFormControlSelect1">{{\App\CPU\translate('قسم')}}<span
        ...
        <select name="type" id="type" class="form-control js-select2-custom">
            ...
            <option value="company">{{ \App\CPU\translate('شركة') }}</option>
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                        <label class="input-label"
                                               for="exampleFormControlInput1">{{\App\CPU\translate('الكمية')}}
                                            <span class="input-label-secondary">*</span>
                                        </label>
                            ...
                            <div class="row pl-2">
                                <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                        <label class="input-label"
                                               for="exampleFormControlInput1">{{\App\CPU\translate('الوحدة')}}
                                            <span class="input-label-secondary">*</span>
                                        </label>
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                        <label class="input-label"
                                               for="exampleFormControlInput1">{{\App\CPU\translate('الوحدة كمية')}}
                                            <span class="input-label-secondary">*</span>
                                        </label>
<input type="number" min="0"  name="unit_value" id="unit_value_input" class="form-control"
       value="{{ old('unit_value') }}"
       placeholder="{{ \App\CPU\translate('unit_value') }}"
       oninput="roundToNearestStep(this, 0.01)">
                            ...
                            <div class="row pl-2">
                                <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                        <label class="input-label"
                                               for="exampleFormControlInput1">{{\App\CPU\translate('سعر  البيع')}}
                                            <span class="input-label-secondary">*</span>
                                        </label>
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                        <label class="input-label"
                                               for="exampleFormControlInput1">{{\App\CPU\translate(' سعر  الشراء')}}
                                            <span class="input-label-secondary">*</span>
                                        </label>
                            ...
                            <div class="row pl-2">
                                <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                        <label class="input-label"
                                               for="exampleFormControlInput1">{{\App\CPU\translate('نوع الخصم')}}</label>
                                        <select onchange="discount_option(this);" name="discount_type"
                                                class="form-control js-select2-custom">
                                            <option
                                                value="percent" {{ old('discount_type')=='percent'?'selected':''}}>{{\App\CPU\translate('نسبة')}}</option>
                                            <option
                                                value="amount" {{ old('discount_type')=='amount'?'selected':''}}>{{\App\CPU\translate('رقم')}}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                        <label id="percent"
                                               class="input-label">{{\App\CPU\translate('نسبة الخصم')}}
                                            (%)</label>
                                        <label id="amount"
                            ...
                            <div class="row pl-2">
                                <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                        <label class="input-label"
                                               for="exampleFormControlInput1">{{\App\CPU\translate('الضريبة بالنسبة')}}
                                            (%)</label>
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                        <label class="input-label"
                                               for="exampleFormControlInput1">{{\App\CPU\translate('اختار مورد')}}</label>
