    ...
    <div class="row align-items-center mb-3">
        <div class="col-sm mb-2 mb-sm-0">
            <h1 class="page-header-title d-flex align-items-center g-2px text-capitalize"><i
                    class="tio-add-circle-outlined"></i> {{\App\CPU\translate('اضافة مورد جديد')}}
            </h1>
        </div>
    </div>
        <!-- End Page Header -->
                        ...
                        <form action="{{route('admin.supplier.store')}}" method="post" enctype="multipart/form-data" >
                            @csrf
                                <div class="row pl-2" >
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            <label class="input-label" >{{\App\CPU\translate('اسم المورد')}} <span
                                ...
                                <div class="row pl-2" >
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            <label class="input-label" >{{\App\CPU\translate('الايميل')}} <span
                                                    class="input-label-secondary text-danger">*</span></label>
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            <label class="input-label" >{{\App\CPU\translate('المقاطعة')}} <span
                                                    class="input-label-secondary text-danger">*</span></label>
                                ...
                                <div class="row pl-2" >
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            <label class="input-label">{{\App\CPU\translate('المدينة')}} <span
                                                    class="input-label-secondary text-danger">*</span></label>
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            <label class="input-label">{{\App\CPU\translate('كود المحافظة')}} <span
                                                    class="input-label-secondary text-danger">*</span></label>
                                ...
                                <div class="row pl-2" >
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            <label class="input-label">{{\App\CPU\translate('العنوان')}} <span
                                                    class="input-label-secondary text-danger">*</span></label>
                                       ...
                                       <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            <label class="input-label">{{\App\CPU\translate('رصيد المورد')}} <span
                                                    class="input-label-secondary text-danger">*</span></label>
                                            <input type="text"  name="balance" class="form-control" value="{{ old('balance') }}"  placeholder="{{\App\CPU\translate('balance')}}" >
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <label>{{\App\CPU\translate('الصورة')}}</label><small class="text-danger"> ( {{\App\CPU\translate('ratio_1:1')}}  )( {{\App\CPU\translate('optional')}}  )</small>
