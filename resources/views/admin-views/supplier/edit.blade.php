...
<div class="content container-fluid">
                            ...
                            @csrf
                                ...
                                <div class="row pl-2" >
                                    <div class="col-12 col-md-6">
                                     ...
                                     <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            <label class="input-label">{{\App\CPU\translate('رصيد المورد')}} <span
                                                    class="input-label-secondary text-danger">*</span></label>
                                            <input type="text"  name="balance" class="form-control" value="{{ $supplier->due_amount }}"  placeholder="{{\App\CPU\translate('balance')}}" >
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6">
    ...
    <!--        <div class="form-group">-->
    <!--            <label class="input-label">{{ __('نوع المورد تعامل الشراء') }} <span class="input-label-secondary text-danger">*</span></label>-->
    <!--            <select name="type" class="form-control" required>-->
    <!--                <option value="1" {{ $supplier->type == 1 ? 'selected' : '' }}>{{ __('يد أولى') }}</option>-->
    <!--                <option value="2" {{ $supplier->type == 2 ? 'selected' : '' }}>{{ __('جملة') }}</option>-->
    <!--                <option value="3" {{ $supplier->type == 3 ? 'selected' : '' }}>{{ __('قطاعي') }}</option>-->
    <!--                <option value="4" {{ $supplier->type == 4 ? 'selected' : '' }}>{{ __('جمهور') }}</option>-->
    <!--                <option value="5" {{ $supplier->type == 5 ? 'selected' : '' }}>{{ __('مندوب') }}</option>-->
    <!--            </select>-->
    <!--        </div>-->
    <!--    </div>-->
    <!--</div>-->

    <!-- New Minimum Balance Field -->
    <!--<div class="row pl-2">-->
    <!--    <div class="col-12 col-sm-6">-->
    <!--        <div class="form-group">-->
    <!--            <label class="input-label">{{ __('الحد الأدنى للاجل') }}</label>-->
    <!--            <input type="number" name="limit" class="form-control" min="0"  value="{{ $supplier->limit }}" placeholder="{{ __('الحد الأدنى للاجل') }}">-->
    <!--        </div>-->
    <!--    </div>-->
    <!--</div>-->
