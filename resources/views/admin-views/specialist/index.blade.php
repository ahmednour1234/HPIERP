            ...
            <div class="row align-items-center mb-3">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title d-flex align-items-center g-2px text-capitalize">
                        ...
                        <span>{{ \App\CPU\translate('اضافة تخصص جديد') }}</span>
                    </h1>
                </div>
            </div>
        </div>
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                                    <div class="form-group">
                                        <label for="">{{ \App\CPU\translate('اسم التخصص') }}</label>
                               ...
                               <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                                    <label>{{ \App\CPU\translate('صورة') }}</label><small class="text-danger">* (
                                        {{ \App\CPU\translate('ratio_1:1') }} )</small>
                                    <div class="custom-file">
                                        <input type="file" name="image" id="customFileEg1" class="custom-file-input"
                                            accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                        <label class="custom-file-label"
                                            for="customFileEg1">{{ \App\CPU\translate('اختار ملف') }} </label>
                                    </div>
                                </div>
